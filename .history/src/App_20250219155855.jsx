  ...
  const projects = [
    {
      ...
      title: "TandingLapang",
      description:
        "Final Project: Tanding Lapang is a platform designed to simplify the search for sparring partners and the organization of sparring events across various sports. This project aims to connect athletes and sports enthusiasts with sparring partners based on location and sport type, while also providing organizers with an efficient way to create and manage sparring events.",
