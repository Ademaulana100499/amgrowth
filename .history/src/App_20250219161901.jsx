  ...
  const projects = [
    {
      ...
      title: "TandingLapang",
      description:
        "Final Project - Dibimbing Bootcamp: Tanding Lapang adalah platform yang dirancang untuk mempermudah pencarian lawan sparring dan penyelenggaraan acara sparring di berbagai cabang olahraga. Dibangun menggunakan HTML, CSS, JavaScript, Tailwind CSS, React.js, dan Next.js, proyek ini menghubungkan atlet dan penggemar olahraga dengan lawan sparring berdasarkan lokasi dan jenis olahraga. Selain itu, platform ini juga menyediakan cara yang efisien bagi penyelenggara untuk membuat dan mengelola acara sparring, memastikan pengalaman yang lancar.",
    ...
    },
    {
      ...
      title: "Aroma Hati",
      description:
        "Mini Project - Dibimbing Bootcamp: Aroma Hati is a promotional website designed to help local cafés establish an online presence. Built using HTML, CSS, and Tailwind CSS, it provides a responsive layout and visually appealing design to enhance branding. This platform enables cafés to showcase their menus, locations, and unique offerings, making it easier for customers to discover and connect with their favorite spots.",
