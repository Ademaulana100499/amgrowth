...
function App() {
  ...
  const imageInfo = {
    ...
    imageBlack: "./src/assets/img/PhotoB2.png",
  };
  const [logoSrc, setLogoSrc] = useState(logo.imageWhite);
  const [imageHomeSrc, setImageHomeSrc] = useState(imageHome.imageWhite);
  ...
  return (
    <div>
      <Header
        ...
        setImageHomeSrc={setImageHomeSrc}
      />
      <Home imageHome={imageSrc} biodata={biodata} />
