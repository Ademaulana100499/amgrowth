...
function App() {
  ...
  const biodata = {
    ...
    description:
      "With a strong passion for web development and a background in Informatics Engineering, I am transitioning into a career as a Front-End Web Developer. I have honed my skills in designing and building responsive, interactive web interfaces using HTML, CSS, JavaScript, and TypeScript. With experience in React.js and Next.js, I focus on creating visually appealing, high-performance, and scalable websites that enhance user experience across devices. Additionally, I have a solid understanding of UI/UX principles, state management, API integration, and website optimization. I am committed to continuous learning and staying updated with the latest technologies to deliver creative, efficient, and modern web solutions.",
