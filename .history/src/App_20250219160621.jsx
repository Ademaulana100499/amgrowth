...
function App() {
  ...
  const projects = [
    ...
    },
    {
      ...
      title: "Foodies",
      description:
        "Mini Project - Dibimbing Bootcamp: Foodies is a recipe website with full CRUD functionality built using Next.js, TypeScript, Tailwind CSS, HTML, and CSS. This project integrates APIs, user authentication, and server-side rendering (SSR) to enhance performance and SEO, providing a seamless and efficient user experience for discovering, managing, and sharing recipes.",
